...
public class BlueAutoLeft extends LinearOpMode {
    ...
    private void placeLeftPixel() {
        ...
        Actions.runBlocking(
                drive.actionBuilder(drive.pose)
                        .strafeTo(new Vector2d(31, -4))
                        .build()
        );
        Actions.runBlocking(
                drive.actionBuilder(drive.pose)
                        .strafeTo(new Vector2d(29.5, -4))
                        .build()
        );
        claw.lowerClaw();
        sleep(200);
    ...
    private void placeRightPixel() {
        ...
        Actions.runBlocking(
                drive.actionBuilder(drive.pose)
                        .strafeTo(new Vector2d(36.3, 39.5))
                        .build()
        );
        claw.openLeft();
        sleep(300);
