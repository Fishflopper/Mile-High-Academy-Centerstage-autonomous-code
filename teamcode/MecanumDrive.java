...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.0008434697683;
        public double lateralInPerTick = 0.0006040526864253021;
        public double trackWidthTicks = 11136.657778027859;

        // feedforward parameters (in tick units)
        public double kS = 0.7910210181759783;
        public double kV = 0.0002157713259600806;
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            p.put("targetX", txWorldTarget.value().position.x);
            p.put("targetY", txWorldTarget.value().position.y);
